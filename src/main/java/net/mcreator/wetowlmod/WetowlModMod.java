 ...
 *
 */
package net.mcreator.wetowlmod;
...
@Mod("wetowl_mod")
public class WetowlModMod {
	public static final Logger LOGGER = LogManager.getLogger(WetowlModMod.class);
	public static final String MODID = "wetowl_mod";
