...
public class Modelrat<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("wetowl_mod", "modelrat"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition backrightleg = partdefinition.addOrReplaceChild(
				"backrightleg", CubeListBuilder.create().texOffs(0, 7).addBox(-0.25F, -1.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(16, 4).addBox(-0.25F, 1.0F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 22.0F, 3.25F));
		PartDefinition backleftleg = partdefinition.addOrReplaceChild(
				"backleftleg", CubeListBuilder.create().texOffs(12, 12).addBox(-0.75F, -1.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(6, 14).addBox(-0.75F, 1.0F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 22.0F, 3.25F));
		PartDefinition frontleftleg = partdefinition
				.addOrReplaceChild(
						"frontleftleg", CubeListBuilder.create().texOffs(0, 17).addBox(0.0F, 1.0F, -3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
								.texOffs(0, 14).addBox(0.0F, 0.0F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
						PartPose.offset(1.0F, 22.0F, -1.0F));
		PartDefinition frontrightleg = partdefinition.addOrReplaceChild(
				"frontrightleg", CubeListBuilder.create().texOffs(16, 14).addBox(-1.0F, 0.0436F, -2.001F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(10, 16).addBox(-1.0F, 1.0436F, -3.001F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.0F, 22.0F, -1.0F));
		PartDefinition tail = partdefinition.addOrReplaceChild("tail", CubeListBuilder.create(), PartPose.offset(-0.5F, 21.0F, 6.0F));
		PartDefinition cube_r1 = tail.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 7).addBox(-1.0F, -1.0F, -0.25F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 1.0F, 0.0F, -0.1309F, 0.0F, 0.0F));
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(12, 0).addBox(-1.0F, -1.5F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 14)
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(8, 7).addBox(-1.5F, -3.5F, -3.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
