...
public class Modelaxolotl_test_texturing<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "axolotl_test_texturing"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition details = partdefinition.addOrReplaceChild("details",
				CubeListBuilder.create().texOffs(0, 22)
						.addBox(5.0F, -5.0F, -5.0F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(4, 16)
		...
		PartDefinition wingleft = details.addOrReplaceChild("wingleft", CubeListBuilder.create(),
		...
		PartDefinition wing2left = wingleft.addOrReplaceChild("wing2left",
				CubeListBuilder.create().texOffs(4, 24)
						.addBox(0.7071F, -1.0F, -4.7071F, 0.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)).texOffs(19, 26)
		...
		PartDefinition wing1left = wingleft.addOrReplaceChild("wing1left",
				CubeListBuilder.create().texOffs(25, 26)
						.addBox(0.7071F, -1.0F, -0.7071F, 0.0F, 1.0F, -3.0F, new CubeDeformation(0.0F)).texOffs(4, 25)
		...
		PartDefinition wingright = details.addOrReplaceChild("wingright", CubeListBuilder.create(),
				PartPose.offset(-3.0F, 0.0F, 7.0F));

		PartDefinition wing1right = wingright.addOrReplaceChild("wing1right",
				CubeListBuilder.create().texOffs(31, 26)
						.addBox(-1.2071F, -1.0F, 2.2929F, 0.0F, 1.0F, -3.0F, new CubeDeformation(0.0F)).texOffs(9, 24)
		...
		PartDefinition wing2right = wingright.addOrReplaceChild("wing2right",
				CubeListBuilder.create().texOffs(5, 25)
						.addBox(-0.7071F, -1.0F, 4.2929F, 0.0F, 1.0F, -1.0F, new CubeDeformation(0.0F)).texOffs(7, 24)
		...
		PartDefinition tail = details.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(18, 5).addBox(-4.0F,
				-5.0F, 0.0F, 7.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition end = tail.addOrReplaceChild("end",
				CubeListBuilder.create().texOffs(18, 0)
						.addBox(-6.0F, -5.0F, -1.0F, 6.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(2.0F, -5.0F, -4.0F, 5.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 13)
						.addBox(-6.0F, -4.0F, -3.0F, 8.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
