...
public class Modelbigfloppa<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bigfloppa"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = tail.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(26, 23).addBox(-0.65F, -1.0F, 0.0F, 1.0F, 1.0F, 10.0F,
		...
		PartDefinition cube_r2 = tail2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(14, 24).addBox(-0.65F, 4.5F, 7.4F, 1.0F, 1.0F, 10.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition backleftleg = partdefinition.addOrReplaceChild("backleftleg", CubeListBuilder.create()
				.texOffs(0, 34).addBox(-0.9F, 0.0F, -1.0F, 2.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition backrightleg = partdefinition.addOrReplaceChild("backrightleg", CubeListBuilder.create()
				.texOffs(26, 23).addBox(-1.5F, 0.0F, -1.0F, 2.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 17.0F, 6.0F));

		PartDefinition frontrightleg = partdefinition.addOrReplaceChild("frontrightleg", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition frontleftleg = partdefinition.addOrReplaceChild("frontleftleg", CubeListBuilder.create()
				.texOffs(27, 0).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 14.0F, -4.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(
				-2.7F, -2.0F, -8.0F, 5.0F, 6.0F, 17.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 14.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 23)
				.addBox(-3.5F, -3.0F, -5.0F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(7, 0)
